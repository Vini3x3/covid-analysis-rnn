...
def create_sequence(seq):
    seq = seq.reshape(-1, 1)
    shifted_sequence = lag_list(seq, 16)  # shift into delayed sequences
...
# range(43, 88), range(146, 265), range(266, 490), range(702, 723)
...
wave_3_x, wave_3_y = create_sequence(wave_3)
wave_4_x, wave_4_y = create_sequence(wave_4)
...
x_test = wave_2_x[TRAIN_RANGE].reshape(1, 15, 1)
y_pred = []
